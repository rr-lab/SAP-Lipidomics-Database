...
Candidate gene counts do not equal signal counts because one significant SNP tags all genes in its LD window. After binning candidates into 250 kb windows, there are 378 distinct windows under CTL and 970 under LIN, so LIN captures ~2.6× more loci, not the near four-fold suggested by gene counts. Hence, CTL loci average 2.9 candidate genes, LIN loci 4.5. Loci also differ in phenotype recurrence. Under CTL, 280/1,100 individual-lipid candidates were linked to ≥7 phenotypes (maximum of 25), while under LIN, 11/4,319 reached ≥7 (maximum of 12). The class-sum/ratio layer shows the same pattern (CTL maximum 64 phenotypes at one locus vs LIN maximum 20). Thus, CTL yields fewer loci with many lipid associations, while LIN yields more loci with few. Because lipid phenotypes are highly correlated by design, these recurrence counts are descriptive summaries, not tests against a null.
