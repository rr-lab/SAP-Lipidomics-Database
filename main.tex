...
What recurrence exists is confined to the individual-species layer. No candidate gene is recovered in both trials for class sums or ratios. The 282 genes shared between trials are all from individual species and include the CMP-sialic acid transporter \texttt{SORBI\_3010G151000} discussed below, together with its chromosome~10 neighbours \texttt{SORBI\_3010G150325} and \texttt{SORBI\_3010G151325}. The CTL and LIN lipid GWAS therefore recover non-overlapping genetic architectures for the class-level traits and largely non-overlapping ones for individual species, where the two trials share no more loci than chance. Candidate gene counts are inflated several-fold by LD in both layers.
