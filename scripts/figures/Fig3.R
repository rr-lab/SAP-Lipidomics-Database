# ==============================================================================
# Figure 3 -- Lipid class composition of the SAP leaf lipidome in each trial.
#
...
#
# This replaces the former Figure 3 (CLR contrast, chemical space, LION), all
# three panels of which were LIN - CTL contrasts.
#
# Output: fig/main/Figure3_Class_Composition.png
...
out_png <- Sys.getenv("FIG3_OUT", file.path(FIG_MAIN, "Figure3_Class_Composition.png"))
