# ==============================================================================
# Figure 1 -- Field-to-database workflow.
#
...
# Output: fig/main/Figure1_Workflow.png
# ==============================================================================
source("scripts/figures/_common.R")
suppressPackageStartupMessages(library(png))

schematic <- Sys.getenv("FIG1_SCHEMATIC",
...
if (!file.exists(schematic))
  stop("Workflow schematic not found at: ", schematic,
       "\n  Export it from FigureLabs.ai and save it there, or set FIG1_SCHEMATIC.")
...
w <- 13.5
save_fig(fig, "Figure1_Workflow.png", width = w, height = w / aspect)
