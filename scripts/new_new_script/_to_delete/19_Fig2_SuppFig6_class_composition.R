...
#                    count, with an arrow from its CTL to its LIN position.
#                    Geometry restored from the original chemical-shift figure
#                    in SoLD_paper/scripts/run_section3_lipidome_overview.R.
#
...
#
# Panel C and Supp Figure S6 are the CTL-LIN contrasts here and both are
# labelled as such.
#
# Inputs
...
# One panel, colour by class and shape by trial, with an arrow running from each
# class's CTL position to its LIN position, as in the original figure.
