...
SHEETS = [
    ("S5D_Class_Composition",      "table/supp/SuppTable_S5D_Class_Composition_pctTIC.csv",
     "Mean %TIC per superclass and per lipid class, within each trial"),
    ("S5E_LION_Enrichment",        "table/supp/SuppTable_S5E_LION_Enrichment.csv",
